...
public class PolicyHandler{
    ...
    @StreamListener(value=KafkaProcessor.INPUT, condition="headers['type']=='CouponPubliched'")
    public void wheneverCouponPubliched_AlertKakao(@Payload CouponPubliched couponPubliched){

        CouponPubliched event = couponPubliched;
        System.out.println("\n\n##### listener AlertKakao : " + couponPubliched + "\n\n");
